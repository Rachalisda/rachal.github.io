...
this is a bootstrap link for developing responsive websites - its the missing link to do cool things
...
function draw() {
     ...
     for(i=0; i<bits.length;i++){
         ...
         if(bits[i].y == canvas.height || (( bits[i].x >= object.x-object.width && bits[i].x <= object.x+object.width) && (bits[i].y <= object.y && bits[i].y>=object.y - object.width))){
             if((( bits[i].x >= object.x-object.width && bits[i].x <= object.x+object.width) && (bits[i].y <= object.y && bits[i].y>=object.y - object.width))){
                 score++;
             }
